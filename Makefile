.PHONY: install test lint typecheck format format-check eval coverage ci example v2-smoke v3-smoke v4-smoke v6-smoke v7-smoke clean-runs clean-cache
...
v6-smoke:
	GAPFORGE_DISABLE_NETWORK=1 $(PYTHON) scripts/v6_smoke.py

v7-smoke:
	GAPFORGE_DISABLE_NETWORK=1 $(PYTHON) scripts/v7_smoke.py
