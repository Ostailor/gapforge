...
class V1ReadinessGate:
    ...
    def evaluate(self) -> V1ReadinessResult:
        ...
        requirements = {
            "deterministic_ci_passed": _json_passed(self.release_dir / "deterministic_ci.json"),
            ...
            "v09_pilot_outcome_accepted": pilot["accepted"],
            "v09_pilot_outcome_is_direction_or_refusal": pilot["outcome_type"] in {"defensible_direction", "correct_refusal"},
            "external_human_pilot_review_exists": pilot["external_review_exists"],
            "no_unresolved_product_failures": not product_failures,
            "migration_audit_passed": _json_passed(audit_paths["migration_audit_passed"]),
            ...
            "full_end_to_end_project_report_exists": bool(report_paths),
        }
...
def _requirement_blockers(requirements: dict[str, bool]) -> list[str]:
    messages = {
        "deterministic_ci_passed": "Deterministic CI has not been recorded as passing.",
        ...
        "v09_pilot_outcome_accepted": "No accepted v0.9 pilot outcome was found.",
        "v09_pilot_outcome_is_direction_or_refusal": "The v0.9 pilot outcome is not a defensible direction or correct refusal.",
        "external_human_pilot_review_exists": "No external/human pilot review record was found.",
        "no_unresolved_product_failures": "Unresolved product failures remain.",
        "migration_audit_passed": "Migration/backward compatibility audit has not passed.",
        ...
        "full_end_to_end_project_report_exists": "No full end-to-end project report was found.",
    }
...
def _warnings(requirements: dict[str, bool], recommended_next_version: str) -> list[str]:
    ...
    if requirements.get("v09_pilot_outcome_accepted") and not requirements.get("v09_pilot_outcome_is_direction_or_refusal"):
        warnings.append("Only defensible-direction and correct-refusal pilot outcomes can count toward v1 readiness.")
    return warnings
